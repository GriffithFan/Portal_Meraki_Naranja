    ...
    return (
      <div className="fixed bottom-4 right-4 z-50 sm:bottom-5 sm:right-5">
            ...
            <div className="flex items-center justify-between border-b border-surface-100 bg-blue-600 px-3 py-3 dark:border-surface-700">
              <div className="flex min-w-0 items-center gap-2">
                ...
                <div className="min-w-0">
                  <h3 className="truncate text-sm font-semibold text-white">{conversacion?.creador?.nombre || "Chat rápido"}</h3>
                  <p className="text-[11px] text-blue-100">{conversacion ? SUPPORT_STATE_BADGE[conversacion.estado]?.label || "Conversación" : "Conversaciones recientes"}</p>
                </div>
              </div>
        ...
        <button
          ...
          title={open ? "Cerrar chat rápido" : "Abrir chat rápido"}
        >
          {open ? (
