  ...
  shell.innerHTML = `
    ...
    <div style="height:48px;background:#153452;color:#fff;display:flex;align-items:center;padding:0 16px;gap:12px;">
      ...
      <div style="display:flex;align-items:center;gap:10px;">
        ...
        <div style="display:flex;align-items:center;gap:5px;color:#fff;font-size:12px;padding:6px 12px;border-radius:25%;background:#344D67;border:1px solid rgba(255,255,255,0.25);">
