...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Calidad datos", href: "/dashboard/calidad-datos", icon: icon("M9 12.75L11.25 15 15 9.75M4.5 19.5h15M4.5 4.5h15M6.75 4.5v15m10.5-15v15"), roles: ["ADMIN", "MODERADOR"] },
      { label: "Diccionario campos", href: "/dashboard/diccionario-campos", icon: icon("M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5A3.375 3.375 0 0010.125 2.25H6.75A2.25 2.25 0 004.5 4.5v15A2.25 2.25 0 006.75 21h10.5a2.25 2.25 0 002.25-2.25v-4.5zM8.25 10.5h3.75M8.25 13.5h7.5M8.25 16.5h7.5"), roles: ["ADMIN", "MODERADOR"] },
  ...
  return (
    <>
      ...
      <div
        aria-hidden="true"
        className={clsx(
          "hidden shrink-0 self-stretch bg-surface-900 transition-[width] duration-300 lg:block",
      ...
      <aside
        className={clsx(
          "h-[100dvh] flex flex-col bg-surface-900 text-surface-300 border-r border-surface-800 overflow-hidden",
          // Desktop: fixed sidebar; the placeholder above preserves layout width and full-page dark background.
          "hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-30 lg:flex transition-[width] duration-300",
          collapsed ? "lg:w-[68px]" : "lg:w-64",
          // Móvil: drawer fijo con slide
          "max-lg:fixed max-lg:inset-y-0 max-lg:left-0 max-lg:z-50 max-lg:w-[min(20rem,88vw)] max-lg:transition-transform max-lg:duration-300 max-lg:ease-out max-lg:shadow-2xl",
          ...
          <div key={section.title} className="mb-2">
            ...
            {!collapsed && (
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold uppercase tracking-wider text-surface-500 hover:text-surface-300 transition-colors"
              >
                {section.title}
                <svg
                  ...
                  return (
                    <li key={item.href}>
                      <Link
                        ...
                        className={clsx(
                          "flex items-center gap-3 px-3 py-3 lg:py-2.5 rounded-xl text-sm font-medium transition-all duration-200",
                          active
