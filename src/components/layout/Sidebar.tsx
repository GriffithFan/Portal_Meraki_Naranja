...
const sections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Ranking", href: "/dashboard/ranking", icon: icon("M16.5 18.75h-9m9 0a3 3 0 003-3V6.75h-15v9a3 3 0 003 3m9 0v1.5m-9-1.5v1.5M9 21h6M7.5 6.75V4.5h9v2.25M4.5 9H3.75A2.25 2.25 0 001.5 11.25v.75A3.75 3.75 0 005.25 15.75M19.5 9h.75a2.25 2.25 0 012.25 2.25v.75a3.75 3.75 0 01-3.75 3.75"), roles: ["ADMIN", "MODERADOR"] },
