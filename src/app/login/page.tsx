...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col bg-surface-50 lg:bg-white">
        {/* Mobile: header con gradiente sutil */}
        <div className="lg:hidden bg-gradient-to-b from-primary-600 to-primary-700 pt-10 pb-8 px-6 text-center rounded-b-[2rem] shadow-lg shadow-primary-700/20">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-white/15 backdrop-blur-sm rounded-2xl mb-3 border border-white/20 shadow-xl shadow-black/10">
            <Image
          ...
          <h1 className="text-2xl font-bold text-white">Carrot</h1>
          <p className="text-xs text-white/60 mt-1">Monitoreo de red & gestión de predios</p>
        </div>

        {/* Form container */}
        <div className="flex-1 flex items-center justify-center px-5 sm:px-10 py-6 sm:py-0">
          <div className="w-full max-w-[400px] animate-fade-in-up">
            {/* Header — solo en desktop (mobile ya tiene el header arriba) */}
            ...
            {/* Header — mobile card */}
            <div className="lg:hidden bg-white rounded-2xl shadow-sm border border-surface-200/60 -mt-6 mb-5 p-5">
              <h2 className="text-lg font-bold text-surface-900">Iniciar sesión</h2>
              <p className="text-xs text-surface-500 mt-0.5">Ingresa tus credenciales para continuar</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              ...
              <div className="lg:contents">
                <div className="bg-white lg:bg-transparent rounded-2xl lg:rounded-none shadow-sm lg:shadow-none border border-surface-200/60 lg:border-0 p-4 lg:p-0 space-y-4">
                  <div>
                    <label htmlFor="email" className="block text-xs sm:text-sm font-medium text-surface-700 mb-1.5">
                      Correo electrónico
                    </label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 text-sm rounded-xl border border-surface-300 bg-surface-50 lg:bg-white text-surface-900
                  ...
                  {/* Password */}
                  <div>
                    <label htmlFor="password" className="block text-xs sm:text-sm font-medium text-surface-700 mb-1.5">
                      Contraseña
                    </label>
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-10 py-2.5 text-sm rounded-xl border border-surface-300 bg-surface-50 lg:bg-white text-surface-900
                          focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent placeholder:text-surface-400 transition-all"
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3 px-4 text-sm font-semibold text-white
                      ...
                      rounded-xl shadow-md shadow-primary-600/25 hover:shadow-lg hover:shadow-primary-600/30
            ...
            <div className="mt-6 sm:mt-8 text-center">
              <p className="text-surface-400 text-[11px] sm:text-xs">
                Carrot &copy; {new Date().getFullYear()} &middot; Griffith_Dev
              </p>
            </div>

            {/* Features compactas — solo mobile */}
            <div className="lg:hidden flex items-center justify-center gap-5 mt-4 pt-4 border-t border-surface-200/50">
              {[
                { label: "Monitoreo", icon: "M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485 0-4.5-4.03-4.5-9S9.515 3 12 3" },
                { label: "Gestión", icon: "M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08" },
                { label: "Calendario", icon: "M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25" },
              ].map((item) => (
